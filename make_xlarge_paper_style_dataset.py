...
for i in range(N_DOCS):
    ...
    # old dataset used 500 repetitions
    # new dataset uses 3000 repetitions to get much longer documents
    text = base * 3000
...
ds.save_to_disk("data/raw_xlarge_paper_style_dataset")

print("Saved dataset to data/raw_xlarge_paper_style_dataset")
print("Documents:", N_DOCS)
print("Base repetitions per document:", 3000)
